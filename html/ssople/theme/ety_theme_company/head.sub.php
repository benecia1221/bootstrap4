...
<link rel="shortcut icon" href="/img/icon.png" type="image/x-ico" />
...
<link href="/ssople/css/heemin.css?ver=<?php echo time(); ?>" type="text/css" rel="stylesheet">
<link href="/ssople/css/heemin_mobile.css?ver=<?php echo time(); ?>" type="text/css" rel="stylesheet">
<!-- google fonts -->
...
<?php
if ($is_member) { // 회원이라면 로그인 중이라는 메세지를 출력
    $sr_admin_msg = '';
